...
const aboutSchema = [
    {
        ...
        '@type': 'AboutPage',
        name: 'About Township Game',
        url: 'https://township-game.online/about',
        description: 'Learn about Township Game, our mission, and the team behind the game.',
        publisher: {
            '@type': 'Organization',
            name: 'Township Game',
...
export const metadata: Metadata = {
    title: 'About Us – Township Game',
    description: 'Learn about Township Game, our mission, and the team behind the game.',
    keywords: ['about Township Game', 'game team', 'who made Township Game'],
};
        ...
        <>
            ...
            <div className="page-header">
                <div className="container">
                    <h1 className="gradient-text">About Township Game</h1>
            ...
            <div className="page-content">
                <h2>Our Story</h2>
                <p>
                    Township Game was born from a simple idea: what if playing Township Game could be even simpler and more accessible?. The result is a game
                    that&apos;s instantly intuitive yet endlessly engaging — an experience unlike any other on the web.
                </p>
                <p>
                    We launched Township Game with a clear vision — to create a free, accessible, and
                    ...
                    Township Game has something for you.
                </p>
                ...
                <p>
                    Every level in Township Game is handcrafted with care. We obsess over the details
                    so you can simply enjoy the game.
                </p>

                <h2>What Makes Us Different</h2>
                <p>
                    Township Game offers a unique experience compared to similar games in its category.
                </p>
                ...
                <p>
                    ...
                    <a href="/contact">Contact page</a>. Your input helps us make Township Game better for
                    everyone.
                </p>
            </div>
        </>

...
const SUPPORT_EMAIL = 'hello@township-game.online';

export const metadata: Metadata = {
    title: 'Contact Township Game',
    description: 'Get in touch with the Township Game team for support, feedback, partnerships, accessibility concerns, or privacy questions.',
    keywords: ['contact Township Game', 'Township Game support', 'game contact'],
    alternates: {
        canonical: '/contact',
    },
};

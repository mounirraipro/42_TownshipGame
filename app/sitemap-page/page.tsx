...
export const metadata: Metadata = {
    ...
    description: 'Browse the complete sitemap of Township Game. Find every page on our website including games, blog posts, and information pages.',
    keywords: ['Township Game sitemap', 'all pages', 'site navigation'],
    alternates: {
...
const sections = [
    {
        ...
        links: [
            { href: '/', label: 'Home' },
            { href: '/play', label: 'Play Township Game' },
    ...
    },
    {
        ...
        links: [
            ...
            { href: '/blog/what-is-jigsolitaire', label: 'What is Township Game?' },
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Browse every page on Township Game.</p>
                </div>
            </div>

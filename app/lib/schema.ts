...
const SITE_URL = 'https://township-game.online';
...
export function buildWebSiteSchema() {
    return {
        ...
        name: 'Township Game',
        url: SITE_URL,
        description: 'Play Township Game free online — no download, no account needed.',
        potentialAction: {
            '@type': 'SearchAction',
            target: {
                '@type': 'EntryPoint',
...
export function buildWebApplicationSchema() {
    return {
        ...
        description:
            'A free browser-based game. Play Township Game online instantly.',
        author: {
            '@type': 'Person',
            name: AUTHOR_NAME,
            url: AUTHOR_URL,

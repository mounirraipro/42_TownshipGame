...
export const metadata: Metadata = {
    title: 'Disclaimer',
    description: 'Read the Township Game disclaimer regarding website content accuracy, external links, and general use of our free online game.',
    keywords: ['Township Game disclaimer', 'website disclaimer', 'legal disclaimer'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    The information provided by Township Game (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;) on township-game.online
                ...
                <p>
                    Township Game is a browser-based entertainment product provided free of charge. The game
                ...
                <p>
                    Township Game displays third-party advertisements (including Google AdSense ads) to
                    ...
                    an endorsement or recommendation by Township Game.
                </p>
                ...
                <p>
                    ...
                    has been obtained from reliable sources, Township Game is not responsible for any errors
